const quizAppLiveLinkBtn = document.querySelector('.js-quiz-app-live-link-btn');
const quizAppRepoLinkBtn = document.querySelector('.js-quiz-app-repo-link-btn');
const employeeDirectoryLiveLinkBtn = document.querySelector('.js-employee-directory-live-link-btn');
const employeeDirectoryRepoLinkBtn = document.querySelector('.js-employee-directory-repo-link-btn');
const webAppDashboardLiveLinkBtn = document.querySelector('.js-web-app-live-link-btn');
